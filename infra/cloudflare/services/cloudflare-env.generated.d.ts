/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=infra/cloudflare/services/wrangler.jsonc --env-interface=CloudflareServicesEnv infra/cloudflare/services/cloudflare-env.generated.d.ts` (hash: 5b1056a936eac5f6da729bc7a4194259)
...
interface __BaseEnv_CloudflareServicesEnv {
	...
	ORDER_FULFILLMENT_WORKFLOW: Workflow<Parameters<import("./src/index").OrderFulfillmentWorkflow['run']>[0]['payload']>;
	SUBSCRIPTION_GENERATION_WORKFLOW: Workflow<Parameters<import("./src/index").SubscriptionGenerationWorkflow['run']>[0]['payload']>;
}
...
interface CloudflareServicesEnv extends __BaseEnv_CloudflareServicesEnv {}
