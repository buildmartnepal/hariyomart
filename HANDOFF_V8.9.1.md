# Hariyo Mart Nepal v8.9.1 — Handoff

This package is the v8.9.1 production-test baseline. It preserves the complete v8.8 commerce/product/Farmer OS stack and adds the Public Story & Trust Experience.
