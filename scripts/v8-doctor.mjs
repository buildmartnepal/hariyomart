...
if (webConfig.name !== 'hariyo-mart-nepal') throw new Error('V8.4.2 web Worker must match the connected Cloudflare Worker: hariyo-mart-nepal');
...
if (pkg.version !== '8.4.2') throw new Error(`Expected v8.4.2 package, got ${pkg.version}`);
